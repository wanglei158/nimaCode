                ...
                <div class="gry8">
                    ...
                    <div class="tank tankt tankt2">
                        <div class="head1">
                            ...
                            <li><i class="required">*</i>库存/件<el-button>批量设置</el-button></li>
                            <li><i class="required">*</i>商品货号<el-button>批量设置</el-button></li>
                            <li>操作</li>
                        </div>
                        <div class="content12">
                            <dl>
            ...
            <template v-else>
                <div class="gry8">
                    ...
                    <div class="tank tankt">
                        <div class="head1">
                            <li>默认</li>
                            <li><i class="required">*</i>供货价/元</li>
                            <li>建议销售价/元</li>
                            <li><i class="required">*</i>库存/件</li>
                            <li><i class="required">*</i>商品货号</li>
                            <li>操作</li>
                        </div>
                        <div class="content1">
                            <li>商品信息</li>
